 ...
 * The q1_incorrect_version.c impolements the incorrect version of semaphore
 * 
 * 
 * Usage Guide
 * (1) gcc -g q1_incorrect_version.c -o q1_incorrect_version.exe -lpthread
 * (2) ./q1_incorrect_version.exe
 */
